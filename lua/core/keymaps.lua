...
vim.keymap.set('n', '<leader>wh', '<C-w>s', { desc = '[H]orizonal Split' }) -- split window horizontally
vim.keymap.set('n', '<leader>we', '<C-w>=', { desc = '[E]qual Width' }) -- make split windows equal width & height
vim.keymap.set('n', '<leader>wc', ':close<CR>', { desc = '[C]lose Split' }) -- close current split window
